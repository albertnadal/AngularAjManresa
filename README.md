...
Finalment prepararem l'aplicació per a que realitzi el renderitzat inicial del site emprant la tècnica del Server-side Rendering (SSR), també anomenat Angular Universal. Observarem que la velocitat de càrrega inicial de l'aplicació millora notablement, ja que tant les crides asíncrones a l'API com el renderitzat dels components es fan al servidor.
